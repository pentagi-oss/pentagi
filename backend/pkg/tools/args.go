...
type FileAction struct {
	Action  FileOp `json:"action" jsonschema:"required,enum=read_file,enum=update_file,description=Action to perform with the code. 'read_file' - Returns the content of the file. 'update_file' - Updates the content of the file"`
